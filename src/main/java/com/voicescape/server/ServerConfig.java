...
public final class ServerConfig {
    ...
    public static final int MAX_BANDWIDTH_BPS = getProperty("max_client_bps");
    ...
    public static final int MAX_PACER_QUEUE = getProperty("max_pacer_queue");
    public static final long MAX_PACER_WAIT_MS = getProperty("max_pacer_wait_ms");
